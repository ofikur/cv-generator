...
export default function ResetModal({ isOpen, onClose, onResetToDefault, onResetToBlank }: Props) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-sm text-center transform transition-all duration-300 scale-100"
      ...
      >
        ...
        <div className="space-y-3">
          <button 
            ...
            className="w-full flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-4 rounded-lg transition-colors"
          >
          ...
          <button 
            onClick={onClose}
            className="w-full flex items-center justify-center gap-2 mt-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded-lg transition-colors"
          >
            Batal
          </button>
        </div>
